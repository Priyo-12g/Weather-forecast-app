...
def getWeather():
    ...
    if 'current' in data:
        ...
        print("Current key not found in data dictionary")

    


    #first cell
    firstdayimage = data['daily'][0]['icon']
    ...
    #second cell
    seconddayimage = data['daily'][1]['icon']

    img=(Image.open(f"icon/{secondaryimage}@2x.png"))
    ...
    #third cell
    thirddayimage = data['daily'][2]['icon']
    ...
    #fourth cell
    fourthdayimage = data['daily'][3]['icon']
    ...
    #fifth cell
    fifthdayimage = data['daily'][4]['icon']
    ...
    #sixth cell
    sixthdayimage = data['daily'][5]['icon']
    ...
    #seventh cell
    seventhdayimage = data['daily'][6]['icon']
...
#label
label1=Label(root,text="Tempearture",font=('Helvetica',11),fg="white",bg="#203243")
